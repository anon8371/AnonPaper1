...
"""
Pretraining with different K values. Full 300 epochs of training. And double the bare min for the GABA switch. Can compare this to the full model which had a much larger GABA switch if 
        desired. 
"""
